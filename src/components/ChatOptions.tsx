    ...
    <div className="p-4 border-t grid grid-cols-2 gap-3 bg-gradient-to-r from-secondary/10 to-primary/5 rounded-b-2xl">
      {options.map((option) => (
        <Button
          ...
          variant="outline"
          className="flex items-center justify-center gap-2 px-3 py-2 text-sm font-bold text-gray-800 bg-white hover:bg-primary/5 border-2 border-primary/20 rounded-lg shadow-sm hover:shadow-md transition-all duration-300 min-h-[3rem]"
        >
